    ...
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <a href="/products" class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2 block">
                <img src="{{ asset('images/product1.jpg') }}" alt="Дульный тормоз-компенсатор для АК-12" class="w-full h-48 object-cover rounded-lg mb-4" loading="lazy">
            ...
            <!-- Карточка товара 2 -->
            <a href="/products" class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2 block">
                <img src="{{ asset('images/product2.jpg') }}" alt="Дульный тормоз-компенсатор для СВД" class="w-full h-48 object-cover rounded-lg mb-4" loading="lazy">
            ...
            <!-- Карточка товара 3 -->
            <a href="/products" class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2 block">
                <img src="{{ asset('images/product3.jpg') }}" alt="Дульный тормоз-компенсатор для АК-74" class="w-full h-48 object-cover rounded-lg mb-4" loading="lazy">
