...
<section class="py-12 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="flex overflow-x-auto md:overflow-visible md:flex-wrap md:justify-center gap-4 md:gap-8">
            <!-- Партнер 1 -->
            <div class="flex-shrink-0 flex flex-col items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="{{ asset('images/partner1.png') }}" alt="Логотип Партнер 1" class="w-24 h-24 object-contain mb-4">
                <span class="text-lg font-semibold text-gray-800">Партнер 1</span>
            </div>

            <!-- Партнер 2 -->
            <div class="flex-shrink-0 flex flex-col items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="{{ asset('images/partner2.png') }}" alt="Логотип Партнер 2" class="w-24 h-24 object-contain mb-4">
                <span class="text-lg font-semibold text-gray-800">Партнер 2</span>
            </div>

            <!-- Партнер 3 -->
            <div class="flex-shrink-0 flex flex-col items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="{{ asset('images/partner3.png') }}" alt="Логотип Партнер 3" class="w-24 h-24 object-contain mb-4">
                <span class="text-lg font-semibold text-gray-800">Партнер 3</span>
            </div>

            <!-- Партнер 4 (ссылка на просмотр других партнеров) -->
            <a href="/partnery" class="flex-shrink-0 flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                <!-- Иконка стрелки -->
